...
public class Jdata
{
	...
	public String getData(String username,String password,String cms,String reportColl)
	{
		...
		try
		{
			BufferedWriter out = new BufferedWriter(new FileWriter("QueryPanelMetadata.txt"));
			String report = "(";
	...
	public String getReportData(String username,String password,String cms,String reportColl)
	{
		String user,pwd,cmsName,reports,dbID,dbPwd;
		...
		try
		{
			BufferedWriter out = new BufferedWriter(new FileWriter("ReportPanelMetadata.txt"));
			String report = "(";
			String[] reportNames = reports.split(",");
			for (int p=0;p<=reportNames.length-1;p++)
			{
			...
			if (oInfoObjects.getResultSize()>0)
			{
				...
				for(int n=0;n<=objectCount-1;n++)
				{
					...
					System.out.println("Should the Document Refresh On Open? "+ docProperties.getProperty("REFRESH_ON_OPEN"));
					out.write("Should the Document Refresh On Open? "+ docProperties.getProperty("REFRESH_ON_OPEN")+"\n");
					System.out.println("Should the Document Auto Merge Dimensions? "+ docProperties.getProperty("MERGE_DIMENSION"));
					out.write("Should the Document Auto Merge Dimensions? "+ docProperties.getProperty("MERGE_DIMENSION")+"\n");
